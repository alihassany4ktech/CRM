        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="{{ $link == route('employee.home') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('employee.home') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="{{ $link == route('employee.projects') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('employee.projects') }}" aria-expanded="false"><i class="mdi mdi-buffer"></i><span class="hide-menu">Projects </span></a></li>

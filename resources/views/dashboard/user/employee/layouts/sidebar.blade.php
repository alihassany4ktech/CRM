            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{ $link == route('user.home') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('user.home') }}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="{{ $link == route('user.employee.projects') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('user.employee.projects') }}" aria-expanded="false"><i class="mdi mdi-buffer"></i><span class="hide-menu">Projects </span></a></li>

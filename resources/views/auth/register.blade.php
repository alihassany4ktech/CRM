...
<body>
    ...
    <section id="wrapper">
        <div class="login-register" style="
          background-image: url({{asset('assets/images/background/login-register.jpg);')}});
        ">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform"
                        ...
                        <div class="form-group">
                          <div class="col-xs-12">
                          <select id="role" type="role" class="form-control @error('role') is-invalid @enderror" name="role"
                    ...
                    " type="submit">
                        ...
                        <div class="form-group m-b-0">
                            <div class="col-sm-12 text-center">
                                ...
                                <a href="{{ route('user.login') }}" class="text-info m-l-5"><b>Sign In</b></a>
                            </div>
                        </div>
                    </form>
                </div>

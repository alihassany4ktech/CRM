        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="{{ $link == route('client.dashboard') ? 'active':'' }}"> <a class="waves-effect waves-dark" href="{{route('client.dashboard')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="{{ $link == route('client.projects') ? 'active':'' }}"> <a class="waves-effect waves-dark" href="{{route('client.projects')}}" aria-expanded="false"><i class="mdi mdi-buffer"></i><span class="hide-menu">Projects </span></a></li>

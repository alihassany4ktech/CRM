                                ...
                                <form method="POST" action="{{route('admin.product.update')}}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                          ...
                                          <input type="number" min="1" value="{{$product->price}}" name="price" class="form-control" id="validationDefault02">
                                           @error('price')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        @foreach ($productCategories as $row)
                                            <option value="{{$row->id}}" {{$row->category_name == $product->category->category_name ? 'selected': ''}}>{{$row->category_name}}</option>
                                        @endforeach
                                          </select>
                                              @error('category')
                                                <small class="text-danger">{{ $message }}</small>
                                        ...
                                        <div class="col-md-6 mb-3">
                                          <label for="validationDefault02">Product Sub Category <a href="#" id="addLeadsource" data-toggle="modal"
                                           ...
                                           <select class="select2 form-control" style="width: 100%" name="subCategory" >
                                            ...
                                            <option value="{{$row->id}}" {{$row->sub_category_name == $product->subcategory->sub_category_name?'selected':''}}>{{$row->sub_category_name}}</option>
                                        @endforeach
                                          </select>
                                         @error('subCategory')
                                                <small class="text-danger">{{ $message }}</small>
                                    ...
                                    {{-- @foreach ($taxes as $row)
                                            <option value="{{$row->id}}" {{$row->tax_name == $product->tax->tax_name? 'selected' : ''}}>{{$row->tax_name}}</option>
                                        ...
                                        <div class="col-md-6 mb-3">
                                          ...
                                          <input type="text" name="code" value="{{$product->hsn_sac_code}}" class="form-control" id="validationDefault01">
                                              @error('code')
                                                <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="form-row">
                                          <div class="col-md-2 mb-3" style="margin-top: 38px">
                                                <input type="checkbox" id="md_checkbox_1" class="chk-col-red" {{$product->allow_purchase == 'Allowed' ? 'checked':''}} name="can_client_purchase"/>

...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="card-title">UPDATE CONTRACT</h4>
                <div class="card">
                    <div class="card-body">
                        <form action="{{route('admin.contract.update')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                        ...
                        <br>
                                ...
                                <div class="col-md-4 mb-4 mt-1">
                                   ...
                                   <select class="select2 form-control" style="width: 100%" name="client" >
                                    ...
                                    @foreach ($clients as $row)
                                        <option value="{{$row->id}}" {{$contract->client->name == $row->name?'selected':''}} >{{$row->name}} ({{$row->company}})</option>
                                    @endforeach
                                </select>
                                    @error('client')
                                 ...
                                 <div class="col-md-4 mb-4">
                                   <label for="validationDefault03">Contract Type <a href="#" type="button" data-toggle="modal" data-target="#responsive-modal"
                                    ...
                                    @foreach ($contractTypes as $row)
                                        <option value="{{$row->id}}" {{$contract->contract_type->name == $row->name?'selected':''}}>{{$row->name}}</option>
                                    @endforeach
                                </select>
                                         @error('contract_type')
                                    <small class="text-danger">{{ $message }}</small>
                            ...
                            <div class="form-row">
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-6 mb-4" id="deadline_div">
                                    ...
                                    <textarea name="alternate_address" id="" cols="30" rows="1" class="form-control">{{$contract->alternate_address}}</textarea>
                             ...
                             <div class="form-row">
                              ...
                              <div class="form-row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea class="summernote" name="summary">{{$contract->summary}}</textarea>
                                    @error('summary')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-4">
                                    ...
                                    <textarea class="summernote" name="note">{{$contract->note}}</textarea>
                                    @error('note')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                           ...
                           <div class="form-row">
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="file" name="company_logo" id="input-file-now-custom-3" class="dropify" data-height="200"
                                        data-default-file="{{$contract->company_logo == null ? asset('assets/images/crmLogo.png') : asset($contract->company_logo)}}"  />
                                          @error('company_logo')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>

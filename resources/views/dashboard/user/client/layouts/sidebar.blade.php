        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <div class="user-profile" style="background: url({{asset('assets/images/background/user-info.jpg')}}) no-repeat;">
                    ...
                    <!-- User profile text-->
                    <div class="profile-text"> <a href="#" class="dropdown-toggle u-dropdown" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true">{{Auth::guard('web')->user()->name}}</a>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="{{ $link == route('user.client.dashboard') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('user.client.dashboard')}}" aria-expanded="false"><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a></li>
                        <li class="{{ $link == route('user.client.projects') ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="{{route('user.client.projects')}}" aria-expanded="false"><i class="mdi mdi-buffer"></i><span class="hide-menu">Projects </span></a></li>

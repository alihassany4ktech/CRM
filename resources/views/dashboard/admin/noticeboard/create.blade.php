        ...
        <!-- End Right sidebar -->
             <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="POST" action="{{route('admin.notice-board.store')}}">
                                      @csrf
                                    <div class="form-row">
                                        <div class="col-md-12 mb-3">
                                          <label for="validationDefault01">Notice Heading<small class="text-danger"> *</small></label>
                                          <input type="text" name="heading" class="form-control" id="validationDefault01">
                                              @error('heading')
                                    ...
                                    <div class="col-md-4 mb-3" style="margin-top: 38px">
                                     <input name="to" type="radio" id="radio_30" value="Employee" class="with-gap radio-col-green" checked/>
                                                <label for="radio_30" class="text-success">To Employee</label>
                                                <input name="to" type="radio" id="radio_32" value="Individual Employee" class="with-gap radio-col-red"/>
                                                <label for="radio_32" class="text-danger">To Individual Employee</label>
                                                <input name="to" type="radio" value="Client" id="radio_31" class="with-gap radio-col-orange"  />

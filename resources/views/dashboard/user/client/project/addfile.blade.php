        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="{{route('client.project.details',['id'=>$id])}}">Project Details</a></li>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('client.project.file.store')}}" method="POST" enctype="multipart/form-data">
                            @csrf

        ...
        <div class="row page-titles">
            <div class="col-md-5 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('admin.departments')}}">HR</a></li>
                    <li class="breadcrumb-item active"><a href="{{route('admin.departments')}}">Departments</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="POST" action="{{route('admin.department.update')}}">
                            ...
                            <div class="form-row mt-2">
                                <div class="col-md-12 mb-3">
                                    <label for="validationDefault03">Department <small
                                            class="text-danger">*</small> </label>
                                    <input type="text" value="{{$department->name}}" name="name" class="form-control" id="validationDefault03" required>
                                </div>
                            </div>
                            <?php
                              $employees = App\User::where('type','=','Employee')->where('department_id','!=',$department->id)->get();
                             ?>
                            <div class="form-row">
                                    <div class="col-md-12 mb-3">
                        ...
                        <div class="row">
                              ...
                              @else
                                       @foreach ($department->members as $row)
                                  <div class="col-md-3 ml-4">

            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li  class="{{$link == route('admin.projects')||$link == route('admin.tasks')|| $link == route('admin.contracts')|| $link == route('admin.project.create')  ? 'active':'' }}"> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hide-menu">Work</span></a>
                            <ul aria-expanded="false" class="collapse">
                                ...
                                <li><a href="{{route('admin.tasks')}}" class="{{$link == route('admin.tasks') ? 'active' : ''}}">Tasks</a></li>

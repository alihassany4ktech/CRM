    ...
    <section id="wrapper">
        <div class="login-register" style="background-image:url({{asset('assets/images/background/login-register.jpg);')}}">
            <div class="login-box card">
                <div class="card-body">
                    <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('user.check') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="d-flex no-block align-items-center">
                                ...
                                <div class="ml-auto">
                                    ...
                                    <a class="text-muted" id="to-recover" href="{{ route('password.request') }}">
                        ...
                        {{-- <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                                <div class="social">
                                    <a href="#" type="button" class="btn btn-facebook" data-toggle="tooltip" title="Login with Facebook"> <i aria-hidden="true" class="fab fa-facebook-f"></i> </a>
                                    <a href="{{route('user.google.login')}}" type="button" class="btn btn-googleplus" data-toggle="tooltip" title="Login with Google"> <i aria-hidden="true" class="fab fa-google-plus-g"></i> </a>
                                </div>
                            </div>
                        </div> --}}

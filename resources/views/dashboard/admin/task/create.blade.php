                    ...
                    <div class="card-body">
                        <form action="{{route('admin.project.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row mt-4">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="validationDefault03">Assigned To<small class="text-danger"> * select multiple</small></label>
                            ...
                            <div class="form-row mt-2">
                                    ...
                                    <label for="validationDefault04">Label
                                        <a href="#" id="addLeadsource" data-toggle="modal"
                                            ...
                                            class="btn btn-sm  btn-outline-success"><i class="fa fa-plus"></i> Add Task Label</a>
                                    </label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3" style="margin-top: 38px">
                                    <label for="validationDefault03">Priority</label> <br>
                                     <input name="notification_status" type="radio" id="radio_30" class="with-gap radio-col-green" checked/>
                                                <label for="radio_30" class="text-success">High</label>
                                                <input name="notification_status" type="radio" id="radio_31" class="with-gap radio-col-orange"  />
                                                <label for="radio_31" style="color: orange">Medium</label>
                                                 <input name="notification_status" type="radio" id="radio_32" class="with-gap radio-col-red" />
            ...
            <div class="modal-body">
                ...
                <form id="formTaskLabel">
                    ...
                    <div class="form-group">
                       ...
                       <textarea name="description" id="" class="form-control" cols="30" rows="1"></textarea>
                    </div>
